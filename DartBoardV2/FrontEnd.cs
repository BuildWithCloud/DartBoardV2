...
public static class FrontEnd
{
    ...
    public static void Instructions()
    {
        ...
        Console.WriteLine("D and T mean Double and Triple. If single is needed, just input the number.");
        Console.WriteLine("For example, 20 means Single 20, D20 means Double 20, T20 means Triple 20.");
        Console.WriteLine("for bull and outer bull, you can input 25 and D25.");
